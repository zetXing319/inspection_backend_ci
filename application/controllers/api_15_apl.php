  ...
  @CHARSET 'UTF-8';
    ...
    .book_page {
     page-break-before: always;
        ...
        $html_header = "<html><head><meta charset='utf-8'/><meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\"/><title>Report</title>".$html_styles."</head><body style='font-family: arial'>
<div style='padding: 0px 33px; max-width: 760px;display: table;margin: 0 auto;width: 100%;'>";


         $newHtml = "<div class='row text-center'><img src='".$this->image_url_change(LOGO_PATH)."' style='max-width: 322px; margin: auto;'></div>
          ...
          <div style='text-align:center;margin: 40px 0 0px;'>
                   ...
                   <p style='margin-bottom: 10px;display: inline-block;'>Date :<span style='border-bottom: 1px solid;'>".$inspection_requested['start_date_requested']."</span></p>
    </div>
...
<table style='border:none;border: none;border-collapse: separate;border-spacing: 0 30px;'>
 ...
 if(!empty($inspection['int_inspection'] == 1)) { 
        ...
        if(count($image_int_inspection)>0) {
            ...
            $newHtml .="<li style='width: 150px; float: left;list-style:none;display:inline-block;'>
            <img src='".base_url().$item['upload_link'].$item['stucco_value_src']."' style='width: auto; margin-top:10px; height: 200px;  text-align: center;'>
            </li>";
              }
              $newHtml .="</ul></div>";
           }
 ...
 if($inspection['stucco_exterior'] == 1) { 
            $newHtml .=" <label class='non unched'>&#9633;</label> Yes <label class='non unched'>&#9745;</label> No <label class='non unched'>&#9633;</label> N/A <label class='non unched'>&#9633;</label> Cannot Verify";
         }elseif($inspection['stucco_exterior'] == 2) { 
            $newHtml .=" <label class='non unched'>&#9745;</label> Yes <label class='non'>&#9633;</label> No <label class='non unched'>&#9633;</label> N/A <label class='non unched'>&#9633;</label> Cannot Verify";
   ...
   $newHtml .="</p> </div>
    ...
    <div>
      ...
      <div style='text-align: center;' class='pdfimage'><img src='".base_url("/resource/upload/stucco/front/").'/'.$inspection['image_front_building']."' style='width: auto; height: 200px;  text-align: center;'></div>
...
<table><tr><td style='width: 40%; '>If Yes, approximately how many cracks per 10 linear feet?</td><td style='width: 30%; border-bottom: 1px solid;'>".$inspection_images['text_front_building2']."</td></tr></table>
...
<table><tr><td style='width: 28%; '>If Yes, what evidence of intrusion? </td><td style='width: 51%; border-bottom: 1px solid;'>".$inspection_images['text_front_building4']."</td></tr></table>
      <br>
   ...
   <div><h1 class='book_page' style='text-align: center;'>Right Elevation</h1></div>
      <div style='text-align: center;' class='pdfimage'><img src='".base_url("/resource/upload/stucco/right/").'/'.$inspection['image_right_building']."' style='width: auto; height: 200px;  text-align: center;'></div>
       

      <div class='sectionsigle' style='line-height:25px;'>5. Any cracks in stucco over wood frame that are greater than or equal to [1/16]'?";  
...
<table><tr><td style='width: 60%; '>If Yes, approximately how many cracks per 10 linear feet? </td><td style='width: 51%; border-bottom: 1px solid;'>".$inspection_images['text_right_building2']."</td></tr></table>
   ...
   $newHtml .="</div>
      ...
      <div style='text-align: center;' class='pdfimage'><img src='".base_url("/resource/upload/stucco/back/").'/'.$inspection['image_back_building']."' style='width: auto; height: 200px;  text-align: center;'></div>

      <div class='sectionsigle' style='line-height:25px;'>9. Any cracks in stucco over wood frame that are greater than or equal to [1/16]'?  ";  
     ...
     <div class='sectionsigle' style='line-height:25px;'>10.  Any cracks in stucco over wood frame that are potentially excessive? ";  
      ...
      <table><tr><td style='width: 57%; '>If Yes, approximately how many cracks per 10 linear feet? </td><td style='width: 51%; border-bottom: 1px solid;'>".$inspection_images['text_back_building2']."</td></tr></table>
...
";
     ...
     $newHtml .="</div>
      ...
      <table><tr><td style='width: 38%; '>If Yes, what evidence of intrusion? </td><td style='width: 51%; border-bottom: 1px solid;'>".$inspection_images['text_back_building4']."</td></tr></table>
     ...
     $newHtml .=" </div>
      ...
      <div style='text-align: center;' class='pdfimage'><img src='".base_url("/resource/upload/stucco/left/").'/'.$inspection['image_left_building']."' style='width: auto; height: 200px;  text-align: center;'></div>

      <div class='sectionsigle' style='line-height:25px;'>13. Any cracks in stucco over wood frame that are greater than or equal to [1/16]'? ";  
     ...
     $newHtml .=" 
      ...
      $newHtml .="<br>
      <span style='color:red;font-size:15px;'>[Include this excessive crack item only if Escrow >= 07.01.16]</span>
       <table><tr><td style='width: 58%; '>If Yes, approximately how many cracks per 10 linear feet?</td><td style='width: 51%; border-bottom: 1px solid;'>".$inspection_images['text_left_building2']."</td></tr></table>
      <br>If Yes, insert closeup photo of representative crack and indicate location on elevation photo.<br>
       ";
    ...
    $image_left_building2=$this->stuccoImgGet($inspection_id,'image_left_building2');
     ...
     $newHtml .=" </div>
      ...
      $newHtml .="<br>
      <table><tr><td style='width: 35%; '>If Yes, what evidence of intrusion? </td><td style='width: 51%; border-bottom: 1px solid;'>".$inspection_images['text_left_building4']."</td></tr></table>
   ...
   <div style='margin: 30px 0 20px;border: 1px solid black;padding: 20px;'>
 ...
 if(!empty($inspection['image_signature'])) {
            $newHtml .="<div style='text-align: left;' class='pdfimagesign'><img src='".base_url("/resource/upload/stucco/signature/").'/'.$inspection['image_signature']."' style='width: 150px;'></div>";
              }
...
//        }
    ...
    function insert_ins()
    {
      ...
      if(isset($_FILES['image_right_building'])){
        ...
        $image_right_building = $uploaddir . $i1.'_'.($_FILES['image_right_building']['name']);

        if (move_uploaded_file($_FILES['image_right_building']['tmp_name'], $image_right_building)) {
           
           $image_right_building =$i1.'_'.($_FILES['image_right_building']['name']);
      ...
      if(isset($_FILES['image_left_building'])){
        ...
        $image_left_building = $uploaddir . $i2.'_'.($_FILES['image_left_building']['name']);

        if (move_uploaded_file($_FILES['image_left_building']['tmp_name'], $image_left_building)) {
           
           $image_left_building =$i2.'_'.($_FILES['image_left_building']['name']);
      ...
      if(isset($_FILES['image_back_building'])){
        ...
        $image_back_building = $uploaddir . $i3.'_'.($_FILES['image_back_building']['name']);

        if (move_uploaded_file($_FILES['image_back_building']['tmp_name'], $image_back_building)) {
           
           $image_back_building =$i3.'_'.($_FILES['image_back_building']['name']);
      ...
      if(isset($_FILES['image_front_building'])){
        ...
        $image_front_building = $uploaddir . $i4.'_'.($_FILES['image_front_building']['name']);

        if (move_uploaded_file($_FILES['image_front_building']['tmp_name'], $image_front_building)) {
           
           $image_front_building =$i4.'_'.($_FILES['image_front_building']['name']);
      ...
      if(isset($_FILES['image_signature'])){
        ...
        $uploaddir = 'resource/upload/stucco/signature/';
         $i21='image_signature';
        $image_signature = $uploaddir . $i21.'_'.($_FILES['image_signature']['name']);

        if (move_uploaded_file($_FILES['image_signature']['tmp_name'], $image_signature)) {
           
           $image_signature =$i21.'_'.($_FILES['image_signature']['name']);
 ...
 $data_request_table= array(
        ...
        $data= array(
         ...
         'image_right_building' => $image_right_building,
         'image_left_building' => $image_left_building,
        ...
        $check_int_inspection = $this->input->post('check_int_inspection');
        $comments_int_inspection = $this->input->post('comments_int_inspection');
       
        $data = $this->get_images('image_int_inspection', $inspection_id,'resource/upload/stucco/interior_inspection/',$check_int_inspection,$comments_int_inspection);
     ...
     if(isset($_FILES['image_right_building3_1'])){
      ...
      if(isset($_FILES['image_left_building3_1'])){
       ...
       $data = $this->get_images('image_left_building4_1', $inspection_id,'resource/upload/stucco/left4/',$checked_left_building4_1,$comments_left_building4_1);
        ...
        $insert = $this->utility_model->insert('ins_inspection_images',$data1);
        
         $this->utility_model->update('ins_inspection_requested', $data_request_table, array('id' => $this->input->post('requested_id')));
...
// // echo json_encode($json);
   ...
   $countfiles = count($_FILES[$image]['name']);
        ...
        $image_building = $uploaddir .time().'_'. $i1.'_'.($_FILES[$image]['name'][$i]);

        if (move_uploaded_file($_FILES[$image]['tmp_name'][$i], $image_building)) {
           
           $image_building =time().'_'.$i1.'_'.($_FILES[$image]['name'][$i]);
          ...
          $data= array(
                   ...
                   'stucco_check' =>$checked,
                   'stucco_comments' =>$comments,
                   'stucco_value_src' => $image_building,
             );

         $insert = $this->utility_model->insert('ins_stucco_image',$data);
