            ...
            <div class="container">
                <div class="row register-box">
                    <form action="<?php echo $basePath; ?>user/signin.html" method="post" role="form">
                        ...
                        <div class="row margin-bottom-10 form-group" style="margin-bottom: 5px;">
                            <input type="password" placeholder="Password" id="password" name="password" class="form-control" required maxlength="100">
                        </div>
                        <div class="row margin-bottom-30 form-group" style="padding-left: 36px; padding-right: 12px;">
                            <div class="checkbox">
                                <label class="" style="color: #000;">
                                    <input type="checkbox" id="user_type" name="user_type" <?php echo isset($login_type) && $login_type=="1" ? "checked" : ""; ?> value="1">
                        ...
                        <div class="row text-center">
                            <a href="#" id="btn_forgot">Forgot Password?</a>
                        </div>
                    </form>
                </div>
        ...
        <script type="text/javascript">
            ...
            function forget_password(email) {
                ...
                $.ajax({
                    ...
                    data: { 
                        email: email,
                        type: $("#user_type").prop('checked') ? "1" : "0"
                    },
                    dataType: 'json',
