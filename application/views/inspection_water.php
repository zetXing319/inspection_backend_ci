                ...
                <div class="col-md-4 col-sm-5 col-xs-6 inspection-logo">
                    ...
                    <div class="row page_content">
                        <div class="col-md-12">
                            ...
                            <!--BEGIN DOWNLOAD ZIP PART-->
                            <div class="row margin-bottom-10">
                                <div class="input-group text-right col-md-offset-2 col-md-6">
                                    <span class="input-group-addon">Community ID: </span>
                                    <input type="text" id="communityID" class="form-control text-right" placeholder="Please input community id of Drainage Plan and Lath inspections to download...">
                                    <div class="input-group-btn">
                                        <button type="button" class="btn btn-success" id="downloadZip">Download Zip</button>
                                    </div>
                                </div>
                            </div>
                            <!--END DOWNLOAD ZIP PART-->
                        </div>
                    </div>
                    <!-- END PAGE CONTENT -->
...
<div id="export_confirm_dialog" class="bootbox modal fade bootbox-confirm modal-overflow" tabindex="-1" role="dialog" aria-hidden="false">
    <div class="modal-dialog">
        ...
        <script src="<?php echo $resPath;?>assets/scripts/inspection_water_download_zip.js" type="text/javascript"></script>
    </body>
