...
<html lang="en" class="no-js">
    ...
    <body class="page-header-fixed page-quick-sidebar-over-content">
        ...
        <form id="form_move_edit" action="<?php echo $basePath; ?>jurisdiction/edit.html" method="post">
            <input type="hidden" name="kind" id="edit_detail_kind" value="">
            <input type="hidden" name="jurisdiction_id" id="edit_detail_id" value="">
        </form>
        ...
        <script src="<?php echo $resPath; ?>assets/scripts/jurisdiction_list.js" type="text/javascript"></script>
