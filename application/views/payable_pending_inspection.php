...
<html lang="en" class="no-js">
    ...
    <body class="page-header-fixed page-quick-sidebar-over-content">
        ...
        ?>                                        
                            ...
                            <div class="row margin-bottom-10">
                                <div class="col-md-6">
                                    <label class="control-label col-md-4" for="epo_status">EPO Status : </label>
                                    <div class="col-md-8">
                                        <select class="form-control" id="epo_status">
                                            <option value="">All</option>
                                            <option value="0_1">To Request and Requested</option>
                                            <option value="0">To Request</option>
                                ...
                                <div class="col-md-6">
                                    <label class="control-label col-md-4" for="payment_status">Payment Status : </label>
                                    <div class="col-md-8">
                            ...
                            <div class="row margin-bottom-10">
                                <div class="col-md-6">
                                    <label class="control-label col-md-4" for="re_inspection">Re-Inspection : </label>
                                    <div class="col-md-8">
                                        <select class="form-control" id="re_inspection">
                                            <option value="">All</option>
                            ...
                            <div class="row table-responsive payable-re-inspection-table">
                                <table id="table_content" class="display" cellspacing="0" cellpadding="0" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Region</th>
                                            <th>Community</th>
                                            <th style="max-width: 64px;">Job Number</th>
                                            <th>Address</th>
                                            <th>Field Manager</th>
                                            <th style="min-width: 64px;">Date</th>
                                            <th style="max-width: 45px;">Result</th>
                                            <th style="max-width: 84px;">EPO Number</th>
                                            <th style="max-width: 64px;">EPO Status</th>
                                            <th style="max-width: 55px;">Payment Status</th>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
...
<div id="email_confirm_dialog" class="bootbox modal fade bootbox-confirm modal-overflow" tabindex="-1" role="dialog" aria-hidden="false">
    <div class="modal-dialog">
        ...
        <script src="<?php echo $resPath;?>assets/scripts/payable_pending_inspection.js" type="text/javascript"></script>
