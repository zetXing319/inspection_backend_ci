        ...
        ?>                                        
                            ...
                            <div class="row table-responsive payable-re-inspection-table">
                                <table id="table_content" class="display" cellspacing="0" cellpadding="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th style="max-width: 48px;">Type</th>
                                            <th style="max-width: 90px;">Region</th>
                                            <th style="max-width: 90px;">Community</th>
                                            <th style="max-width: 64px;">Job Number</th>
                                            <th style="max-width: 100px;">Address</th>
                                            <th style="max-width: 90px;">Field Manager</th>
                                            <th style="min-width: 64px;">Date</th>
                                            <th style="max-width: 45px;">Result</th>
                                            <th style="max-width: 45px;">Status</th>
                                            <th style="max-width: 90px;">Re-Inspection Count</th>
                                            <th style="width: 64px;">EPO Number</th>
                                            <th style="width: 64px;">EPO Status</th>
                                            <th style="width: 64px;">Invoice Number</th>
                                            <th></th>
                                        </tr>
                                    </thead>
                                </table>
...
<div id="email_confirm_dialog" class="bootbox modal fade bootbox-confirm modal-overflow" tabindex="-1" role="dialog" aria-hidden="false">
    <div class="modal-dialog">
        ...
        <script src="<?php echo $resPath;?>assets/scripts/payable_re_inspection.js" type="text/javascript"></script>
