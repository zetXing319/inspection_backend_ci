    ...
    if ($user_permission != 5) {
        ?>
                        <div class="row margin-bottom-10 form-group">
                            ...
                            <div class="col-md-5">
                                <input type="text"  placeholder="" readonly="" id="date_requested_get_endrange" name="date_requested"   class="form-control no-readonly"  value="<?php if($inspection['requested_at']){echo $inspection['requested_at'];}else{}?>">
                                 <input type="hidden" id="id" name="id" class="form-control" value="<?php echo $inspection['id'];?>">
                                  ...
                                  <input type="hidden" id="type" name="type" class="form-control" value="5">
                                   
                            </div>
                        </div>
 <?php }else{
    ?>
   <input type="hidden" readonly placeholder="" id="date_requested_get_endrange" name="date_requested"   class="form-control no-readonly"   value="<?php echo date('Y-m-d');?>">
   <input type="hidden" id="id" name="id" class="form-control" value="<?php echo $inspection['id'];?>">
   <input type="hidden" id="inspectorid" name="inspectorid" class="form-control" value="<?php echo $inspection['inspector_id'];?>">
    ...
    <?php
                        ...
                        ?>
                             <div class="row margin-bottom-10 form-group">
                                ...
                                <div class="col-md-5">
                                    <input type="email"  required  placeholder="" id="email" name="email" class="form-control"  maxlength="100" value="<?php echo $inspection['email'];?>">
                                </div>
                            </div>
                             <?php
                           }else
                           {
                            ...
                            <div class="row margin-bottom-10 form-group">
                                ...
                                <div class="col-md-5">
                                    <input type="email" readonly required  placeholder="" id="email1" name="email1" class="form-control"  maxlength="100" value="<?php echo $inspection['email'];?>">
                                </div>
                            </div>
                            <?php
                           }
        ...
        if($inspection['job_number']==""){
                        ?>
                           <div class="row margin-bottom-10 form-group for-model-home-hidden">
                            ...
                            <div class="col-md-5"><label class="control-label col-md-3 hidden" for="job_number">Job Number :</label>
                                <input <?php echo $check_flag1?'readonly':'' ?> type="hidden" placeholder="xxxx-xxx-xx" readonly data-mask="" id="job_number" name="job_number" class="form-control input-custom"  maxlength="11" value="<?php echo $inspection['job_number'];?>">
                                 <input type="hidden" id="job_number12" class="form-control" value="">
        ...
        if($user_permission != 5) {
             ?>
                        ...
                        <div class="row margin-bottom-10 form-group">
                            <label class="control-label col-md-3" for="community_name">Community Name :</label>
                           <div class="col-md-5">
                                <input type="text" placeholder="" id="community_name1" name="community_name" class="form-control" value="<?php echo $inspection['community_name'];?>">
                                <input type="hidden" placeholder="" id="community_id" name="community_id" class="form-control" value="<?php echo $inspection['community_id'];?>">
                            </div>
                        </div>
                      <?php
        ...
        if($user_permission != 5) {
             ?>
                         <div class="row margin-bottom-10 form-group">
                            ...
                            <div class="col-md-5">
                                <input type="text" readonly placeholder="" id="region_name" name="region_name" class="form-control"  value="<?php echo $inspection['region']; ?>">
                                  <input type="hidden" placeholder="" id="region" name="region" class="form-control"  value="<?php echo $inspection['region']; ?>">
                            </div>
                        </div>
                        <?php
                       }else{
            ...
            //  maxDate: dateToday,
              ...
              start: {}, // start picker options
                ...
                onSelect: function (selectedDate) {
                            ...
                            $("#date_requested_get_endrange").attr("value",selectedDate);
                        } 
              } // end picker options         
            }
            );
...
function load_data(query)
 {
  $.ajax({
   ...
   //  $('#address').val(data[0].address);
     $('#community_id').val(data.community_name);
     $('#job_number12').val(data.job_number);
