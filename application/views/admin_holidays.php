...
<html lang="en" class="no-js">
    ...
    <body class="page-header-fixed page-quick-sidebar-over-content">
                    ...
                    <div class="row page_content profile-page">
                        <div class="col-md-11">
                            ...
                            foreach ($holidays as $key => $value) {
                                ...
                                $valid = $value['valid'];
                                $id = $value['id'];
                                echo '<div class="row margin-bottom-10 form-group">';

                                echo '<div class="col-md-1">';

                                if ($valid == 1) {
                                  echo "<input type='checkbox' name='holidays' value='$id' checked>";
                                }else{
                                  echo "<input type='checkbox' name='holidays' value='$id'>";
                                }

                                echo '</div>';
                                echo '<label class="control-label col-md-7" for="report_keep_day">'.$value['name'].'</label>';
                                echo '</div>';
                            }
                             ?>
        ...
        <script src="<?php echo $resPath;?>assets/scripts/admin_holidays.js" type="text/javascript"></script>
